...
tags:
  - email
parent: "[[Email Skratch Directory Structure]]"
---
---
...
- `localization` - Information about the email template localization and current language, which is automatically set as English.
- `browserslist` - The settings for the email template compatibility with the email client versions.
